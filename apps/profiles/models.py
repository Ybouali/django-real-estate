...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+72718192762")
    about_me = models.TextField(verbose_name=_("About Me"), default="say something about yourself")
    liecense = models.CharField(verbose_name=_("Real Estate Liecense"), max_length=30, blank=True, null=True)
    ...
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you looking to by a property?"))
    ...
    to_agent = models.BooleanField(verbose_name=_("Top agent"), default=False)
